...
if __name__ == '__main__':
    ...
    parser.add_argument('--nativedir', type=is_file, required=True)
    ...
    for native_pdb in os.listdir(args.nativedir):
        ...
        for model in os.listdir(args.indir + '/' + targetname):
            ...
            process_list.append([args.mmalign_program, args.nativedir + '/' + native_pdb, args.indir + '/' + targetname + '/' + model, outdir + '/' + model + '_filtered_out'])
