...
from bml_casp15.quaternary_structure_refinement.iterative_refine_pipeline_v7_human import *
...
flags.DEFINE_list('default_dirs', None, 'Monomer alignment directory')
...
def main(argv):
    ...
    for fasta_path, default_dir, inpdb_dir in zip(FLAGS.fasta_paths, FLAGS.default_dirs, FLAGS.inpdb_dirs):
        ...
        multimer_res_all, multimer_res_avg, multimer_res_max = pipeline.search(fasta_path, default_dir,
                                                                               inpdb_dir,
