...
from bml_casp15.tertiary_structure_evaluation.pipeline import *
...
def main(argv):
    ...
    pipeline = Tertiary_structure_evaluation_pipeline(params=params, run_methods=["apollo", "alphafold", "enQA"], use_gpu=FLAGS.use_gpu)
