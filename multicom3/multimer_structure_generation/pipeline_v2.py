        ...
        while True:
            ...
            for method in self.run_methods:
                ...
                if concatenate_method == "default":
                    ...
                    species_msa_pair_file = os.path.join(complex_aln_dir, "species_interact_uniref_a3m/species_interact_uniref_a3m_interact.csv")
                    ...
                    if len(pd.read_csv(msa_pair_file)) <= 1 or \
                        ...
                        continue
                    a3m_paths = [os.path.join(complex_aln_dir, concatenate_method, monomer + "_con.a3m") for monomer in monomers]
                else:
                    msa_pair_file = os.path.join(complex_aln_dir, concatenate_method, concatenate_method + "_interact.csv")
                ...
                if template_method == "":
                    ...
                    if len(pd.read_csv(template_file)) < 4:
                        template_file = os.path.join(template_dir, "struct_temp", "structure_templates_v2.csv")
                    ...
                    if len(pd.read_csv(template_file)) < 4:
                        template_file = os.path.join(template_dir, "pdb_seq", "sequence_templates_v2.csv")
                        if len(pd.read_csv(template_file)) == 0:
                            continue
                        outdir += '_v2'
                    base_cmd += f"--temp_struct_csv={template_file} "
                    ...
                    if len(pd.read_csv(template_file)) < 4:
                        template_file = os.path.join(template_dir, "complex_pdb_seq", "sequence_templates_v2.csv")
                        if len(pd.read_csv(template_file)) == 0:
                            continue
                        outdir += '_v2'
                    base_cmd += f"--temp_struct_csv={template_file} "
                    ...
                    if len(pd.read_csv(template_file)) < 4:
                        template_file = os.path.join(template_dir, "pdb70_seq", "sequence_templates_v2.csv")
                        if len(pd.read_csv(template_file)) == 0:
                            continue
                        outdir += '_v2'
                    template_hits_files = []
