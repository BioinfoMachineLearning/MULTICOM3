...
def main(argv):
    ...
    for chain_id in chain_id_map:
        ...
        if monomer_sequence not in processed_seuqences:
            ...
            if not run_monomer_structure_generation_pipeline_v2(params=params,
                                                                ...
                                                                outdir=N3_monomer_outdir, run_methods=['default','default_uniref_22','default_newest','default_uniclust']):
    ...
    if not run_quaternary_structure_generation_homo_pipeline_v2(params=params,
                                                                ...
                                                                run_methods=['default_multimer','default_uniref30_22','default_mul_newest','default_uniclust30']):
