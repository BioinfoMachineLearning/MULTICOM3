...
if [ $# != 7 ]
then
        echo "USAGE: chainA name, chainA fasta file, chainA a3m file, chainB name, chainB fasta file, chainB a3m file, output folder"
        exit 1
fi
...
CHAINID2=$4
FASTAFILE2=$5 #Path to fasta file of chain2
