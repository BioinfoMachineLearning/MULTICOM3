...
class Complex_structure_based_template_search_pipeline:
    ...
    def search(self, monomer_sequences, monomers_pdbs, outdir, is_homodimer=False):
        ...
        self.search_nocheck(monomer_sequences, monomers_pdbs, outdir, is_homodimer)

    def search_nocheck(self, monomer_sequences, monomers_pdbs, outdir, is_homodimer=False):
